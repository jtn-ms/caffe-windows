// testclassification.cpp : Defines the entry point for the console application.
//
...
#else
	Mat img;
	resize(origin, img, Size(224, 224));
#endif
	return img;
}
...
char img[] = "H:\\Samples\\Remotes\\Real\\aircon-tornado-legend-real.png";
...
int main(int argc, char** argv) {
	...
	if (argc != 6) {
		...
		trained_file = dir + trained;
		mean_file = dir + mean_fn;
	...
	cv::Mat img = refineMat(file);//cv::imread(file, -1);
